...
namespace DataAccessObjects
{
    public class PostDAO
    {
        ...
        //-----------------------------------------------------------------------------------------------------
        public static List<Post> GetbyPostID(int Id)
        {
            List<Post> PostList = new List<Post>();
            List<Post> RealPostList = new List<Post>();
            try
        ...
        //-----------------------------------------------------------------------------------------------------
        public static List<Post> GetbyKeyWord(string keyword)
        {
            List<Post> PostList = new List<Post>();
            List<Post> RealPostList = new List<Post>();
            try
            {
                ...
                for (int i = 0; i < PostList.Count; i++)
                {
                    if (PostList[i].Title.Contains(keyword, StringComparison.InvariantCultureIgnoreCase) 
                        || PostList[i].PostContent.Contains(keyword, StringComparison.InvariantCultureIgnoreCase))
                    {
                        RealPostList.Add(PostList[i]);
                    }
                }
