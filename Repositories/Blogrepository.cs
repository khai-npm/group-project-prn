...
namespace Repositories
{
    public class Blogrepository : IBlogrepository
    {
        ...
        public List<Comment> GetbyPostId(int Author) => CommentDAO.GetbyPostComment(Author);
        ...
        public List<Post> GetbyPostID(int Id) => PostDAO.GetbyPostID(Id);
        public List<Post> GetbyKeyWord(string keyword) => PostDAO.GetbyKeyWord(keyword);
